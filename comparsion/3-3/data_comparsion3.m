...
q_CNC = CtrlData(:,5);  Dlt_e_CNC = CtrlData(:,11);  
Ero_alp_CNC = CtrlData(:,14);  Ero_qw_CNC = CtrlData(:,17);  Dlt_alp_CNC = CtrlData(:,23);
...
plot(T1,Ero_alp_CNC*Rad2Deg,'--b','LineWidth',2); 
...
axis([0 50 -2 1.1])
h1=legend('NPPSMC','SSMC','CNC','Location','SouthEast');
set(h1,'box','off');
